...
# <b> = {b, b*b, b*b*b, ...., e}
# ici l'operateur * est la multiplication dans F_2^m
# et e = 1
        L = [b]
...
# version dispose de la multiplication
# on verifie alors que b*c = 1 dans le corps
 return multiplication(b,c,f)==1
 
def is_sym_mul(b,c,f):
# version l'on dispose des tables log
# si b = alpha^i et c = alpha^j alors
# c est le symetrique de b si i+j = 0 modulo 2^m-1
# point aborde lors de la question 5 de l'exercice 1 du TD3
    m = len(bin(f))-3
